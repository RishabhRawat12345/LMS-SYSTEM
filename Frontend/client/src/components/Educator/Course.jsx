              ...
              {course.length === 0 ? (
                ...
                course.map((c) => (
                  <tr key={c._id} className="border-t hover:bg-gray-50 transition">
                    <td className="p-4">
                      <div
                        onClick={() => navigate("/aboutC", { state: c._id })}
                      ...
                      >
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm text-gray-500">{c.subtitle}</span>
                        </div>
                      </div>
                    </td>
                    <td className="p-4">₹{c.price || 0}</td>
                    <td className="p-4">
                      <span
                      ...
                      >
                        {c.isPublised ? "Published" : "Not Published"}
                      </span>
                    </td>
                    <td className="p-4">
